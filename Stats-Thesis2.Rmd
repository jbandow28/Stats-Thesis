...
AB_IQR <- summary(HOF_batters$AB)[5] - summary(HOF_batters$AB)[2]
low_outliers_AB <- summary(HOF_batters$AB)[2] - 1.5*AB_IQR

batters <- baseball %>% filter(position != "P" & votedBy != "Negro League" & str_sub(playerID, -2, -1) != "99" & AB >= low_outliers_AB & finalGame < as.Date("2004-01-01"))
